...
#define NEOPIXEL_BRIGHTNESS 0x73
...
unsigned int samplingInterval = 51; // how often to run the main loop (in ms)
...
void loop()
{
  ...
  if (currentMillis - previousMillis > samplingInterval) {
    ...
    if (numActiveSonars)
    {
      pingResult = sonars[nextSonar]->ping();
